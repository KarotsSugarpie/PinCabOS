...
class SingleEventDofRunner:
    ...
    def send_event_token(
        ...
        *,
        ...
        # PinCabOS: VPinFE random menu range E900-E990 is intentionally silent.
        # Explicit menu events outside this range still work normally.
        if type_char.upper() == "E" and 900 <= number <= 990:
            self._clear_pending_commands()
