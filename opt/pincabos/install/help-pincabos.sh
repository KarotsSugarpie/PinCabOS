...
Current clean reinstall guarantees:
  ...
  - 03-install-check creates/validates pincabos-vpinfe.service compatibility wrapper when missing
HELP_BGFX_CLEAN
...
Role:
  ...
  - enables pincabos-vpinfe.service and pincabos-vpinfe.service
